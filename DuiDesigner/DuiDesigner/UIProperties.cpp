...
#pragma region Control
	...
	pPropUI->AddSubItem(pPropColor);
	//bkcolor3
	pPropColor = new CMFCPropertyGridColorProperty(_T("BkColor3"), (LONG)RGB(0, 0, 0), NULL, _T("指定控件的背景颜色3"), tagBkColor2);//bkcolor3
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
	//bordercolor
...
#pragma region Label
	...
	//enabledeffect
	pProp = new CMFCPropertyGridProperty(_T("EnabledEffect"), (_variant_t)false, _T("指示是否使用Effect"), tagEnabledeffect);
	pPropUI->AddSubItem(pProp);

	//rahh
	pProp = new CMFCPropertyGridProperty(_T("Rahh"), (_variant_t)(LONG)0, _T("字体质量0-5"), tagRahh);
	pPropUI->AddSubItem(pProp);

	//enabledshadow
	pProp = new CMFCPropertyGridProperty(_T("EnabledShadow"), (_variant_t)false, _T("指示是否使用阴影效果"), tagEnabledshadow);
	pPropUI->AddSubItem(pProp);

	//transtext
	pProp = new CMFCPropertyGridProperty(_T("TransText"), (_variant_t)(LONG)100, _T("TransText"), tagTransText);
	pPropUI->AddSubItem(pProp);

	//transshadow
	pProp = new CMFCPropertyGridProperty(_T("TransShadow"), (_variant_t)(LONG)100, _T("TransShadow"), tagTransShadow);
	pPropUI->AddSubItem(pProp);

	//transtext1
	pProp = new CMFCPropertyGridProperty(_T("TransText1"), (_variant_t)(LONG)100, _T("TransText1"), tagTransText1);
	pPropUI->AddSubItem(pProp);

	//transshadow1
	pProp = new CMFCPropertyGridProperty(_T("TransShadow1"), (_variant_t)(LONG)100, _T("TransShadow1"), tagTransShadow1);
	pPropUI->AddSubItem(pProp);

	//shadowoffset
	pValueList = new CMFCPropertyGridProperty(_T("ShadowOffset"), tagShadowoffset, TRUE);
	pProp = new CMFCPropertyGridProperty(_T("offsetx"), (_variant_t)(LONG)0, _T("OffsetX"));
	pValueList->AddSubItem(pProp);
	pProp = new CMFCPropertyGridProperty(_T("offsety"), (_variant_t)(LONG)0, _T("OffsetY"));
	pValueList->AddSubItem(pProp);
	pPropUI->AddSubItem(pValueList);

	//gradientangle
	pProp = new CMFCPropertyGridProperty(_T("GradientAngle"), (_variant_t)(LONG)0, _T("渐变色渲染角度"), tagGradientAngle);
	pPropUI->AddSubItem(pProp);

	//gradienlength
	pProp = new CMFCPropertyGridProperty(_T("GradienLength"), (_variant_t)(LONG)0, _T("渐变距离"), tagGradientlength);
	pPropUI->AddSubItem(pProp);

	//enabledstroke
	pProp = new CMFCPropertyGridProperty(_T("EnabledStroke"), (_variant_t)false, _T("是否使用描边效果"), tagEnabledStroke);
	pPropUI->AddSubItem(pProp);

	//transstroke
	pProp = new CMFCPropertyGridProperty(_T("TransStroke"), (_variant_t)(LONG)255, _T("字体描边的颜色透明度 0-255"), tagTransStroke);
	pPropUI->AddSubItem(pProp);

	//textcolor1
	pPropColor = new CMFCPropertyGridColor32Property(_T("TextColor1"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("字体渐变色"), tagTextcolor1);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);

	//textshadowcolora
	pPropColor = new CMFCPropertyGridColor32Property(_T("TextShadowColorA"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("字体阴影渐变色"), tagTextshadowcolora);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);

	//textshadowcolorb
	pPropColor = new CMFCPropertyGridColor32Property(_T("TextShadowColorB"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("字体阴影渐变色"), tagTextshadowcolorb);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);

	//strokecolor
	pPropColor = new CMFCPropertyGridColor32Property(_T("StrokeColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("字体描边的颜色"), tagStrokecolor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
...
#pragma region Button
	...
	pPropUI->AddSubItem(pPropImage);
	//foreimage
	pPropImage = new CMFCPropertyGridImageProperty(_T("ForeImage"), _T(""), _T("指定按钮正常显示ForeImage"), tagButtonForeImage);//foreimage
	pPropImage->AllowEdit(FALSE);
	pPropUI->AddSubItem(pPropImage);
	//hotforeimage
	pPropImage = new CMFCPropertyGridImageProperty(_T("HotForeImage"), _T(""), _T("指定按钮获得热点时的Fore图片"), tagButtonHotforeImage);//hotforeimage
	pPropImage->AllowEdit(FALSE);
	pPropUI->AddSubItem(pPropImage);
	//hotbkcolor
	pPropColor = new CMFCPropertyGridColor32Property(_T("HotBkColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("HotBkColor"), tagButtonHotBkColor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
	//hottextcolor
	pPropColor = new CMFCPropertyGridColor32Property(_T("HotTextColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("HotTextColor"), tagButtonHotTextColor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
	//pushedtextcolor
	pPropColor = new CMFCPropertyGridColor32Property(_T("PushedTextColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("PushedTextColor"), tagButtonPushedTextColor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
	//focusedtextcolor
	pPropColor = new CMFCPropertyGridColor32Property(_T("FocusedTextColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("FocusedTextColor"), tagButtonFocusedTextColor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
...
#pragma region Edit
	...
	//numberonly
	pProp = new CMFCPropertyGridProperty(_T("NumberOnly"), (_variant_t)false, _T("指示是否只读"), tagNumberOnly);
	pPropUI->AddSubItem(pProp);
	...
	//prompt
	pProp = new CMFCPropertyGridImageProperty(_T("Prompt"), _T(""), _T("指定编辑框被禁用后的图片"), tagEditPrompt);
	pProp->AllowEdit(FALSE);
	pPropUI->AddSubItem(pProp);
...
#pragma region Option
	...
	pPropUI->AddSubItem(pProp);
	//notfilterselected
	pProp = new CMFCPropertyGridProperty(_T("NotFilterSelected"), (_variant_t)false, _T("指示是否已被选中"), tagOptNotFilterSelected);
	pPropUI->AddSubItem(pProp);
	//selectedhotimage
	pPropImage = new CMFCPropertyGridImageProperty(_T("SelectHotImage"), _T(""), _T("指定复选框被选择后的图片"), tagOptSelectHotImage);//selectedimage
	pPropImage->AllowEdit(FALSE);
	pPropUI->AddSubItem(pPropImage);
	//selectedpushedimage
	pPropImage = new CMFCPropertyGridImageProperty(_T("SelectPushedImage"), _T(""), _T("指定复选框被选择后的图片"), tagOptSelectPushedImage);//selectedimage
	pPropImage->AllowEdit(FALSE);
	pPropUI->AddSubItem(pPropImage);
	//selectedtooltip
	pProp = new CMFCPropertyGridProperty(_T("SelectedTooltip"), _T(""), _T("SelectedTooltip"), tagOptSelectedTooltip);//value
	pPropUI->AddSubItem(pProp);
	//selectedtextcolor
	pPropColor = new CMFCPropertyGridColor32Property(_T("SelectedTextColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("SelectedTextColor"), tagOptSelectedTextColor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);
...
#pragma region Slider
	...
	pProp = new CMFCPropertyGridProperty(_T("Step"), (_variant_t)(LONG)0, _T("指定进度步长，如(1)"), tagThumStep);//value
	pPropUI->AddSubItem(pProp);
...
#pragma region Item
	...
	//ItemAltBk
	pProp = new CMFCPropertyGridProperty(_T("ItemAltBk"), (_variant_t)false, _T("指示是否使用Html格式文本\nFalse"), tagItemAltBK);
	pPropUI->AddSubItem(pProp);

	//ItemMutilSelect
	pProp = new CMFCPropertyGridProperty(_T("ItemMutilSelect"), (_variant_t)false, _T("指示是否使用Html格式文本\nFalse"), tagItemMutilSelect);
	pPropUI->AddSubItem(pProp);
...
#pragma region Combo
	...
	//ComboDropBox
	pProp = new CMFCPropertyGridProperty(_T("DropBox"), (_variant_t)_T(""), _T("ComboDropBox"), tagComboDropBox);
	pPropUI->AddSubItem(pProp);
...
#pragma region TileLayout
	...
	pPropUI->AddSubItem(pProp);
	pValueList = new CMFCPropertyGridProperty(_T("ColumnSize"), tagItemSize, TRUE);//size
	pProp = new CMFCPropertyGridProperty(_T("cx"), (_variant_t)(LONG)0, _T("窗体的宽度"));
	pValueList->AddSubItem(pProp);
	pProp = new CMFCPropertyGridProperty(_T("cy"), (_variant_t)(LONG)0, _T("窗体的高度"));
	pValueList->AddSubItem(pProp);
...
#pragma region List
	...
	//ListScrollSelect
	pProp = new CMFCPropertyGridProperty(_T("ListScrollSelect"), (_variant_t)false, _T("是否随滚动改变选中项\nFalse)"), tagListScrollSelect);
	pPropUI->AddSubItem(pProp);
...
#pragma region AnimTabLayout
	pPropUI = new CMFCPropertyGridProperty(_T("AnimTabLayout"), classAnimTabLayout);

	// direction
	pProp = new CMFCPropertyGridProperty(_T("AnimDirection"), _T("horizontal"), _T(""), tagAnimationDirection);
...
#pragma endregion AnimTabLayout
...
#pragma region ListHeaderItem
	...
	// endellipsis
	pProp = new CMFCPropertyGridProperty(_T("Endellipsis"), (_variant_t)true, _T("是否显示默认页面\ntrue"), tagListHeaderItemEndellipsis);
	pPropUI->AddSubItem(pProp);

	// showhtml
	pProp = new CMFCPropertyGridProperty(_T("ShowHtml"), (_variant_t)true, _T("是否显示默认页面\ntrue"), tagListHeaderItemShowHtml);
	pPropUI->AddSubItem(pProp);

	pValueList = new CMFCPropertyGridProperty(_T("ItemTextPadding"), tagListHeaderItemTextPadding, TRUE);//padding
	pProp = new CMFCPropertyGridProperty(_T("Left"), (_variant_t)(LONG)0, _T("指定控件内部的左边距"));
	pValueList->AddSubItem(pProp);
	pProp = new CMFCPropertyGridProperty(_T("Top"), (_variant_t)(LONG)0, _T("指定控件内部的上边距"));
	pValueList->AddSubItem(pProp);
	...
	//ItemTextColor
	pPropColor = new CMFCPropertyGridColor32Property(_T("ItemTextColor"), (LONG)ARGB(0, 0, 0, 0), NULL, _T("指定组项分割线的颜色"), tagListHeaderItemTextColor);
	pPropColor->EnableOtherButton(_T("其他..."));
	pPropColor->EnableAutomaticButton(_T("默认"), ::GetSysColor(COLOR_3DFACE));
	pPropUI->AddSubItem(pPropColor);

	//font
	pProp = new CMFCPropertyGridProperty(_T("ItemFont"), (_variant_t)(LONG)0, _T("分隔符宽\n4"), tagListHeaderItemFont);
	pPropUI->AddSubItem(pProp);

	//ItemAlign
	pProp = new CMFCPropertyGridProperty(_T("ItemAlign"), _T("Center"), _T("指示文本的对齐方式"), tagListHeaderItemAlign);
	pProp->AddOption(_T("Center"));
	pProp->AddOption(_T("Left"));
	pProp->AddOption(_T("Right"));
	pProp->AddOption(_T("Top"));
...
#pragma region WkeBrowser

	pPropUI = new CMFCPropertyGridProperty(_T("WkeWebkit"), classWkeBrowser);

	// url
	pProp = new CMFCPropertyGridProperty(_T("url"), (_variant_t)_T(""), _T("默认网址\n"), tagWkeBrowserURL);
	pPropUI->AddSubItem(pProp);

	m_wndPropList.AddProperty(pPropUI);
#pragma endregion WkeBrowser
...
void CUIProperties::ShowProperty(CControlUI* pControl)
{
	...
	case classTabLayout:
		...
		break;
	case classAnimTabLayout:
		ShowAnimTabLayoutPropery(pControl);
		break;
	case classList:
	...
	case classWebBrowser:
		...
		break;
	case classWkeBrowser:
		ShowWkeBrowserPropery(pControl);
		break;
...
void CUIProperties::ShowLabelProperty(CControlUI* pControl)
{
	...
	//enabledeffect
	pPropLabel->GetSubItem(tagEnabledeffect - tagLabel)->SetValue((_variant_t)pLabel->GetEnabledEffect());
	pPropLabel->GetSubItem(tagEnabledeffect - tagLabel)->SetOriginalValue((_variant_t)pLabel->GetEnabledEffect());
	//rahh
	pPropLabel->GetSubItem(tagRahh - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetTextRenderingHintAntiAlias());
	pPropLabel->GetSubItem(tagRahh - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetTextRenderingHintAntiAlias());
	//enabledshadow
	pPropLabel->GetSubItem(tagEnabledshadow - tagLabel)->SetValue((_variant_t)pLabel->GetEnabledShadow());
	pPropLabel->GetSubItem(tagEnabledshadow - tagLabel)->SetOriginalValue((_variant_t)pLabel->GetEnabledShadow());
	//transtext
	pPropLabel->GetSubItem(tagTransText - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetTransText());
	pPropLabel->GetSubItem(tagTransText - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetTransText());
	//transshadow
	pPropLabel->GetSubItem(tagTransShadow - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetTransShadow());
	pPropLabel->GetSubItem(tagTransShadow - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetTransShadow());
	//transtext1
	pPropLabel->GetSubItem(tagTransText1 - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetTransText());
	pPropLabel->GetSubItem(tagTransText1 - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetTransText());
	//transshadow1
	pPropLabel->GetSubItem(tagTransShadow1 - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetTransShadow());
	pPropLabel->GetSubItem(tagTransShadow1 - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetTransShadow());
	//shadowoffset
	RectF size = pLabel->GetShadowOffset();
	pValueList = pPropLabel->GetSubItem(tagShadowoffset - tagLabel);
	pValueList->GetSubItem(0)->SetValue((_variant_t)(LONG)(size.X));
	pValueList->GetSubItem(1)->SetValue((_variant_t)(LONG)size.Y);
	pValueList->GetSubItem(0)->SetOriginalValue((_variant_t)(LONG)size.X);
	pValueList->GetSubItem(1)->SetOriginalValue((_variant_t)(LONG)size.Y);
	//gradientangle
	pPropLabel->GetSubItem(tagGradientAngle - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetGradientAngle());
	pPropLabel->GetSubItem(tagGradientAngle - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetGradientAngle());
	//gradienlength
	pPropLabel->GetSubItem(tagGradientlength - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetGradientLength());
	pPropLabel->GetSubItem(tagGradientlength - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetGradientLength());
	//enabledstroke
	pPropLabel->GetSubItem(tagEnabledStroke - tagLabel)->SetValue((_variant_t)pLabel->GetEnabledStroke());
	pPropLabel->GetSubItem(tagEnabledStroke - tagLabel)->SetOriginalValue((_variant_t)pLabel->GetEnabledStroke());
	//transstroke
	pPropLabel->GetSubItem(tagTransStroke - tagLabel)->SetValue((_variant_t)(LONG)pLabel->GetTransStroke());
	pPropLabel->GetSubItem(tagTransStroke - tagLabel)->SetOriginalValue((_variant_t)(LONG)pLabel->GetTransStroke());
	//textcolor1
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagTextcolor1 - tagLabel))->SetColor((_variant_t)(LONG)(pLabel->GetTextColor1()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagTextcolor1 - tagLabel))->SetOriginalValue((_variant_t)(LONG)(pLabel->GetTextColor1()));
	//textshadowcolora
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagTextshadowcolora - tagLabel))->SetColor((_variant_t)(LONG)(pLabel->GetTextShadowColorA()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagTextshadowcolora - tagLabel))->SetOriginalValue((_variant_t)(LONG)(pLabel->GetTextShadowColorA()));
	//textshadowcolorb
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagTextshadowcolorb - tagLabel))->SetColor((_variant_t)(LONG)(pLabel->GetTextShadowColorB()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagTextshadowcolorb - tagLabel))->SetOriginalValue((_variant_t)(LONG)(pLabel->GetTextShadowColorB()));
	//strokecolor
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagStrokecolor - tagLabel))->SetColor((_variant_t)(LONG)(pLabel->GetStrokeColor()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropLabel->GetSubItem(tagStrokecolor - tagLabel))->SetOriginalValue((_variant_t)(LONG)(pLabel->GetStrokeColor()));
...
void CUIProperties::ShowButtonProperty(CControlUI* pControl)
{
	...
	//foreimage
	pPropButton->GetSubItem(tagButtonForeImage - tagButton)->SetValue((_variant_t)pButton->GetForeImage());
	pPropButton->GetSubItem(tagButtonForeImage - tagButton)->SetOriginalValue((_variant_t)pButton->GetForeImage());
	//hotforeimage
	pPropButton->GetSubItem(tagButtonHotforeImage - tagButton)->SetValue((_variant_t)pButton->GetHotForeImage());
	pPropButton->GetSubItem(tagButtonHotforeImage - tagButton)->SetOriginalValue((_variant_t)pButton->GetHotForeImage());
	//hotbkcolor
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonHotBkColor - tagButton))->SetColor((_variant_t)(LONG)(pButton->GetHotBkColor()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonHotBkColor - tagButton))->SetOriginalValue((_variant_t)(LONG)(pButton->GetHotBkColor()));
	//hottextcolor
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonHotTextColor - tagButton))->SetColor((_variant_t)(LONG)(pButton->GetHotTextColor()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonHotTextColor - tagButton))->SetOriginalValue((_variant_t)(LONG)(pButton->GetHotTextColor()));
	//pushedtextcolor
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonPushedTextColor - tagButton))->SetColor((_variant_t)(LONG)(pButton->GetPushedTextColor()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonPushedTextColor - tagButton))->SetOriginalValue((_variant_t)(LONG)(pButton->GetPushedTextColor()));
	//focusedtextcolor
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonFocusedTextColor - tagButton))->SetColor((_variant_t)(LONG)(pButton->GetFocusedTextColor()));
	static_cast<CMFCPropertyGridColor32Property*>(pPropButton->GetSubItem(tagButtonFocusedTextColor - tagButton))->SetOriginalValue((_variant_t)(LONG)(pButton->GetFocusedTextColor()));
...
void CUIProperties::ShowEditProperty(CControlUI* pControl)
{
	...
	//propmt
	pPropEdit->GetSubItem(tagEditPrompt - tagEdit)->SetValue((_variant_t)pEdit->GetPrompt());
	pPropEdit->GetSubItem(tagEditPrompt - tagEdit)->SetOriginalValue((_variant_t)pEdit->GetPrompt());
...
void CUIProperties::ShowOptionProperty(CControlUI* pControl)
{
	...
	//notfilterselected
	pPropOption->GetSubItem(tagOptNotFilterSelected - tagOption)->SetValue((_variant_t)pOption->IsNotFilterSelected());
	pPropOption->GetSubItem(tagOptNotFilterSelected - tagOption)->SetOriginalValue((_variant_t)pOption->IsNotFilterSelected());
	//selectedhotimage
	pPropOption->GetSubItem(tagOptSelectHotImage - tagOption)->SetValue((_variant_t)pOption->GetSelectedHotImage());
	pPropOption->GetSubItem(tagOptSelectHotImage - tagOption)->SetOriginalValue((_variant_t)pOption->GetSelectedHotImage());
	//selectedpushedimage
	pPropOption->GetSubItem(tagOptSelectPushedImage - tagOption)->SetValue((_variant_t)pOption->GetSelectedPushedImage());
	pPropOption->GetSubItem(tagOptSelectPushedImage - tagOption)->SetOriginalValue((_variant_t)pOption->GetSelectedPushedImage());
	//selectedtooltip
	pPropOption->GetSubItem(tagOptSelectedTooltip - tagOption)->SetValue((_variant_t)pOption->GetSelectedToolTip());
	pPropOption->GetSubItem(tagOptSelectedTooltip - tagOption)->SetOriginalValue((_variant_t)pOption->GetSelectedToolTip());
	//selectedtextcolor
	static_cast<CMFCPropertyGridColor32Property*>(pPropOption->GetSubItem(tagOptSelectedTextColor - tagOption))->SetColor((_variant_t)(LONG)pOption->GetSelectedTextColor());
	static_cast<CMFCPropertyGridColor32Property*>(pPropOption->GetSubItem(tagOptSelectedTextColor - tagOption))->SetOriginalValue((_variant_t)(LONG)pOption->GetSelectedTextColor());
...
void CUIProperties::ShowSliderProperty(CControlUI* pControl)
{
	...
	//step
	pPropSlider->GetSubItem(tagThumStep - tagSlider)->SetValue((_variant_t)(LONG)pSlider->GetChangeStep());
	pPropSlider->GetSubItem(tagThumStep - tagSlider)->SetOriginalValue((_variant_t)(LONG)pSlider->GetChangeStep());
...
void CUIProperties::ShowComboProperty(CControlUI* pControl)
{
	...
	pValueList->GetSubItem(3)->SetOriginalValue((_variant_t)(LONG)rect.bottom);
	//dropbox
	pPropCombo->GetSubItem(tagComboDropBox - tagCombo)->SetValue((_variant_t)pCombo->GetDropBoxAttributeList());
	pPropCombo->GetSubItem(tagComboDropBox - tagCombo)->SetOriginalValue((_variant_t)pCombo->GetDropBoxAttributeList());
	//dropboxsize
...
void CUIProperties::ShowTileLayoutProperty(CControlUI* pControl)
{
	...
	//ItemSize
	SIZE size = pTileLayout->GetItemSize();
	CMFCPropertyGridProperty* pValueList = pPropTileLayout->GetSubItem(tagItemSize - tagTileLayout);
	pValueList->GetSubItem(0)->SetValue((_variant_t)(LONG)size.cx);
	pValueList->GetSubItem(1)->SetValue((_variant_t)(LONG)size.cy);
	pValueList->GetSubItem(0)->SetOriginalValue((_variant_t)(LONG)size.cx);
	pValueList->GetSubItem(1)->SetOriginalValue((_variant_t)(LONG)size.cy);
...
void CUIProperties::ShowListProperty( CControlUI* pControl )
{
	...
	//scrollselect
	pPropList->GetSubItem(tagListScrollSelect - tagList)->SetValue((_variant_t)pList->GetScrollSelect());
	pPropList->GetSubItem(tagListScrollSelect - tagList)->SetOriginalValue((_variant_t)pList->GetScrollSelect());
...
void CUIProperties::ShowItemProperty( CControlUI* pControl )
{
	...
	//altbk
	pPropItem->GetSubItem(tagItemAltBK - tagItem)->SetValue((_variant_t)pListInfo->bAlternateBk);
	pPropItem->GetSubItem(tagItemAltBK - tagItem)->SetOriginalValue((_variant_t)pListInfo->bAlternateBk);
	//multiselect
	pPropItem->GetSubItem(tagItemMutilSelect - tagItem)->SetValue((_variant_t)pListInfo->bMultiSelect);
	pPropItem->GetSubItem(tagItemMutilSelect - tagItem)->SetOriginalValue((_variant_t)pListInfo->bMultiSelect);
...
void CUIProperties::ShowAnimTabLayoutPropery(CControlUI* pControl)
{
	ShowTabLayoutPropery(pControl);

	ASSERT(pControl);
	CAnimationTabLayoutUI* pTabLayout = static_cast<CAnimationTabLayoutUI*>(pControl->GetInterface(_T("AnimationTabLayout")));
	ASSERT(pTabLayout);

	CMFCPropertyGridProperty* pPropItem = m_wndPropList.FindItemByData(classAnimTabLayout, FALSE);
	ASSERT(pPropItem);

	//direction
	CString strDirection = _T("horizontal");
	if (pTabLayout->IsVerticalDirection())
		strDirection = _T("vertical");
	
	pPropItem->GetSubItem(tagAnimationDirection - tagAnimTabLayout)->SetValue((_variant_t)strDirection);
	pPropItem->GetSubItem(tagAnimationDirection - tagAnimTabLayout)->SetOriginalValue((_variant_t)strDirection);
...
void CUIProperties::ShowWkeBrowserPropery(CControlUI* pControl)
{
	ShowControlProperty(pControl);

	ASSERT(pControl);
	CWkeWebkitUI* pWkeBrowser = static_cast<CWkeWebkitUI*>(pControl->GetInterface(_T("WkeWebkit")));
	ASSERT(pWkeBrowser);

	CMFCPropertyGridProperty* pPropItem = m_wndPropList.FindItemByData(classWkeBrowser, FALSE);
	ASSERT(pPropItem);

	//	homepage
	pPropItem->GetSubItem(tagWkeBrowserURL - tagWkeBrowser)->SetValue((_variant_t)pWkeBrowser->GetUrl());
	pPropItem->GetSubItem(tagWkeBrowserURL - tagWkeBrowser)->SetOriginalValue((_variant_t)pWkeBrowser->GetUrl());
