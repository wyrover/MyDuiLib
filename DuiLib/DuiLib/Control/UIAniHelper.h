...
#pragma pack() // turn byte alignment off
	...
	public:
		...
		const TImageInfo* LoadGIF(CPaintManagerUI* pManager,LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);
	...
	protected:
		...
		const TImageInfo* AddAniImage(HDC hDC, CPaintManagerUI* pManager, LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);
