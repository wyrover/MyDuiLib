...
public:
	...
	bool LoadFromFileDirectly(LPCTSTR pstrPath, LPCTSTR pstrFilename, int encoding = XMLFILE_ENCODING_UTF8);
	bool LoadFromZipFile(LPCTSTR pstrZip,LPCTSTR pstrFilename, int encoding = XMLFILE_ENCODING_UTF8);
...
public:
	...
	int GetAttributeInt(LPCTSTR pstrName);
	bool GetAttributeBool(LPCTSTR pstrName);
	float GetAttributeFloat(LPCTSTR pstrName);
