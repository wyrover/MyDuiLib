...
public:
	...
	static HBITMAP LoadBitmap(CPaintManagerUI* pManager, STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0);
	static TImageInfo* LoadImage(CPaintManagerUI* pManager, STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0);
