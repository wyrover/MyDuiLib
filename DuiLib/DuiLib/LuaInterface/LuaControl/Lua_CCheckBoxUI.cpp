...
namespace DuiLib
{
	LUA_METHOD_IMPL(CCheckBoxUI, New)
	{
	...
	LUA_METHOD_IMPL(CCheckBoxUI, GetClassName)
	{
	...
	LUA_METHOD_IMPL(CCheckBoxUI,GetCheck)
	{
		try
		{
			CCheckBoxUI* self;
	...
	LUA_METHOD_IMPL(CCheckBoxUI,SetCheck)
	{
		try
		{
			CCheckBoxUI* self;
	...
	LUA_CLASS_REG_IMPL(CCheckBoxUI)
	{
		lua_newtable(l);
