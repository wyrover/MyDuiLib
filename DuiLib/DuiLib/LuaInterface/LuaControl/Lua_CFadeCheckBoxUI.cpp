...
namespace DuiLib
{
	LUA_METHOD_IMPL(CFadeCheckBoxUI, New)
	{
	...
	LUA_METHOD_IMPL(CFadeCheckBoxUI, GetClassName)
	{
	...
	LUA_METHOD_IMPL(CFadeCheckBoxUI,GetCheck)
	{
		try
		{
	...
	LUA_METHOD_IMPL(CFadeCheckBoxUI,SetCheck)
	{
		try
		{
			CFadeCheckBoxUI* self;
	...
	LUA_CLASS_REG_IMPL(CFadeCheckBoxUI)
	{
		lua_newtable(l);
