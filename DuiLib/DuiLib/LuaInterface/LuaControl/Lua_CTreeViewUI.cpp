...
namespace DuiLib
{
	LUA_METHOD_IMPL(CTreeNodeUI, New)
	{
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetClassName)
	{
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetVisibleTag)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetVisibleTag)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetItemText)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetItemText)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, CheckBoxSelected)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, IsCheckBoxSelected)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, IsHasChild)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetTreeLevel)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, AddChildNode)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetParentNode)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetParentNode)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetCountChild)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetTreeView)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetTreeView)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetChildNode)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetVisibleFolderBtn)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetVisibleFolderBtn)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetVisibleCheckBtn)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetVisibleCheckBtn)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetItemTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetItemTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetItemHotTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetItemHotTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetSelItemTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetSelItemTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, SetSelItemHotTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_METHOD_IMPL(CTreeNodeUI, GetSelItemHotTextColor)
	{
		try
		{
			CTreeNodeUI* self;
	...
	LUA_CLASS_REG_IMPL(CTreeNodeUI)
	{
		lua_newtable(l);
...
namespace DuiLib
{
	LUA_METHOD_IMPL(CTreeViewUI, New)
	{
		CTreeViewUI  *self = new CTreeViewUI();
		LuaStatic::AddObject2Lua(l, self, METATABLE_NAME(self));
		return 1;
	}
	LUA_METHOD_IMPL(CTreeViewUI, GetClassName)
	{
	...
	LUA_METHOD_IMPL(CTreeViewUI, AddAt2)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetItemCheckBox)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetItemExpand)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetVisibleFolderBtn)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, GetVisibleFolderBtn)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetVisibleCheckBtn)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, GetVisibleCheckBtn)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetItemMinWidth)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, GetItemMinWidth)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetItemHotTextColor)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetSelItemTextColor)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_METHOD_IMPL(CTreeViewUI, SetSelItemHotTextColor)
	{
		try
		{
			CTreeViewUI* self;
	...
	LUA_CLASS_REG_IMPL(CTreeViewUI)
	{
		lua_newtable(l);
		static LuaReg StaticFuncs[] =
		{
