...
namespace DuiLib
{
	LUA_METHOD_IMPL(CNotifyPump, AddVirtualWnd)
	{
		try
		{
			CNotifyPump* self;
	...
	LUA_METHOD_IMPL(CNotifyPump, RemoveVirtualWnd)
	{
		try
		{
			CNotifyPump* self;
	...
	LUA_METHOD_IMPL(CNotifyPump, NotifyPump)
	{
		try
		{
			CNotifyPump* self;
	...
	LUA_METHOD_IMPL(CNotifyPump, LoopDispatch)
	{
		try
		{
			CNotifyPump* self;
	...
	LUA_CLASS_REG_IMPL(CNotifyPump)
	{
		lua_newtable(l); // t,
...
namespace DuiLib
{
	LUA_METHOD_IMPL(CWindowWnd, GetClassName)
	{
		lua_pushstring(l, "WindowWnd");
		return 1;
	}
	LUA_METHOD_IMPL(CWindowWnd, isnil)
	{
		CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, _gc)
	{
		CWindowWnd* self;
		self = static_cast<CWindowWnd*>(LuaStatic::CheckUserData(l, 1));
	...
	LUA_METHOD_IMPL(CWindowWnd, _eq)
	{
		try
		{
			CWindowWnd* left;
	...
	LUA_METHOD_IMPL(CWindowWnd, _tostring)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, Delete)
	{
		CWindowWnd* self;
		self = static_cast<CWindowWnd*>(LuaStatic::CheckUserData(l, 1));
		LuaStatic::RemoveObjectInLua(l);
	...
	LUA_METHOD_IMPL(CWindowWnd, GetHWND)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, RegisterWindowClass)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, RegisterSuperclass)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, Create)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, Create2)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, CreateDuiWindow)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, Subclass)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, Unsubclass)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, ShowWindow)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, ShowModal)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, Close)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, CenterWindow)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, SetIcon)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, SendMessage)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, PostMessage)
	{
		try
		{
			CWindowWnd* self;
	...
	LUA_METHOD_IMPL(CWindowWnd, ResizeClient)
	{
		try
		{
			CWindowWnd* self;
