...
//	LPCTSTR GetCustomStyleByName(LPCTSTR pStrStyleName) const;
	...
	///////////////////////////////////////////
    CDuiString GetCurResourcePath();
    void SetCurResourcePath(LPCTSTR lpstrPath);
	CDuiString GetCurResourceZip();
	void SetCurResourceZip(LPCTSTR lpstrZip,bool bCached = false);

	static bool IsZipResourceCached(LPCTSTR lpstrZip);
	static void AddZipResourceCached(LPCTSTR lpstrZip);
	static HANDLE GetCachedZipResource(LPCTSTR lpstrZip);
private:
...
//    HBITMAP m_hbmpBackground;
	...
	//
	HINSTANCE m_hCurResourceInstance;
    CDuiString m_pStrCurResourcePath;
    CDuiString m_pStrCurResourceZip;
	static CStdStringPtrMap m_aCurZipCached;
	//
