...
CDuiString CLoginList::GetSkinPath()
{
	return CPaintManagerUI::GetInstancePath();
}
CDuiString CLoginList::GetSkinFolder()
{
	return _T("QQ\\skin\\0");
}
UILIB_RESOURCETYPE CLoginList::GetResourceType() const
{
	return UILIB_ZIP;
}
CDuiString CLoginList::GetZIPFileName() const
{
	return _T("0.zip");
}
