...
public:
    ...
    LRESULT HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        if( uMsg == WM_CREATE ) {
			...
			CDuiString sXML = CPaintManagerUI::GetInstancePath() + _T("test1.xml");
            CControlUI* pRoot = builder.Create(sXML.GetData(), (UINT)0, NULL, &m_pm);
...
public:
    ...
    void*/*CWndShadow**/ m_pWndShadow;
};


int RunTestApp(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
